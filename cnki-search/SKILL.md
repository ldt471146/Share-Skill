...
name: cnki-search
description: >
  在中国知网 CNKI 检索中文学术论文、期刊、学位论文、会议论文、论文详情和参考文献。；在中国知网 CNKI 检索中文学术论文、期刊、学位论文、会议论文、论文详情和参考文献。
  在中国知网（CNKI）上检索学术论文。触发场景：用户要求搜索知网论文、查找文献、检索期刊/学位论文/会议论文， 或提到"知网"、"CNKI"、"中国知网"、"文献检索"、"论文搜索"等关键词时使用此 skill。
